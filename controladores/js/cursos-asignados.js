...
function renderCursoCard(curso) {
  const imgSrc = curso.imagenUrl ? getImageUrl(curso.imagenUrl, '../recursos/img/7g.jpg') : '../recursos/img/7g.jpg';
  ...
  card.addEventListener('click', () => {
    window.location.href = `../vista/material.html?cursoId=${encodeURIComponent(curso.id)}`;
  });
